...
export function ApprovalCard({
  ...
  const kindLabel = formatApprovalType(approval.type) || typeLabel[approval.type] || approval.type;
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {requesterAgent && (
                  <div className="inline-flex min-w-0 items-center gap-1.5 text-xs text-muted-foreground">
                    <span>{t("approvalDetail.requestedBy")}</span>
            ...
            {showResolutionButtons && (
              <>
                <Button
                  ...
                  disabled={isPending}
                >
                  {pendingAction === "approve" ? `${t("approvalDetail.approve")}...` : t("approvalDetail.approve")}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
                  ...
                  disabled={isPending}
                >
                  {pendingAction === "reject" ? `${t("approvalDetail.reject")}...` : t("approvalDetail.reject")}
                </Button>
              </>
            )}
          </div>
